...
public class Home extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ht=(ImageButton)findViewById(R.id.imageView9);
        Ht.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hti=new Intent(Home.this,HealthTips.class);
                startActivity(hti);
            }
        });
        Med=(ImageButton)findViewById(R.id.imageView11);
        Med.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hti=new Intent(Home.this,KnowYourMed.class);
                startActivity(hti);
            }
        });
        ayur=(ImageButton)findViewById(R.id.imageView10);
        ayur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hti=new Intent(Home.this,AyurvedicTips.class);
                startActivity(hti);
            }
        });
        fAid=(ImageButton)findViewById(R.id.imageView7);
        fAid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hti=new Intent(Home.this,FirstAidTips.class);
                startActivity(hti);
            }
        });
        HS=(ImageButton)findViewById(R.id.imageView5);
        HS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hti=new Intent(Home.this,HealthSchemes.class);
                startActivity(hti);
            }
        });
